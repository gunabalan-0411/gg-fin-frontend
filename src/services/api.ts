...
export const voiceApi = {
  modelStatus: () => api.get<{ loaded: boolean; on_disk: boolean; downloading: boolean; idle_seconds: number; seconds_until_unload: number }>("/voice/model-status"),
  modelLoad: () => api.post<{ loaded: boolean; on_disk: boolean; downloading: boolean; idle_seconds: number; seconds_until_unload: number }>("/voice/model-load"),
  modelUnload: () => api.post<{ loaded: boolean; on_disk: boolean; downloading: boolean; idle_seconds: number; seconds_until_unload: number }>("/voice/model-unload"),
