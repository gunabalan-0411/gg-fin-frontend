...
function LoanSummaryCards({ data }: { data: LoanSummary }) {
  const cards = [
    ...
    { label: "IOP — Outstanding Receivable", value: data.iop_total_receivable, color: "hsl(var(--accent))", tag: "IOP" },
  ];
  return (
    <>
      {cards.map((c) => (
        <div key={c.label} className="col-span-6 xl:col-span-3 rounded-xl border border-border bg-card p-[16px_18px]">
